...
{
    public class IntervalSoundState : ISoundState
    {
        ...
        public XElement GenerateXml()
        {
            ...
            xmlElement.Add(new XAttribute("Interval", Interval.ToString()));
        ...
        public void PopulateFromXml(XElement element)
        {
            ...
            Interval = Convert.ToInt32(element.Attribute("Interval").Value);
        }
    }
}